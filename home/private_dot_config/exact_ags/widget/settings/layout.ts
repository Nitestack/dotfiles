...
export default [
  Page(
    ...
    Group(
      ...
      Row({ opt: dark.view, title: "View Background", type: "color" }),
      Row({ opt: dark.card, title: "Card Background", type: "color" }),
      Row({ opt: dark.surface, title: "Surface Background", type: "color" }),
      Row({ opt: dark.fg, title: "Text", type: "color" }),
      Row({ opt: dark.primary.bg, title: "Primary Background", type: "color" }),
      Row({ opt: dark.primary.accent, title: "Primary Accent", type: "color" }),
      Row({ opt: dark.error.bg, title: "Error Background", type: "color" }),
      Row({ opt: dark.error.accent, title: "Error Accent", type: "color" }),
      Row({ opt: dark.success.bg, title: "Success Background", type: "color" }),
      Row({ opt: dark.success.accent, title: "Success Accent", type: "color" }),
      Row({ opt: dark.warning.bg, title: "Warning Background", type: "color" }),
      Row({ opt: dark.warning.accent, title: "Warning Accent", type: "color" }),
    ...
    Group(
      ...
      Row({ opt: light.view, title: "View Background", type: "color" }),
      Row({ opt: light.card, title: "Card Background", type: "color" }),
      Row({ opt: light.surface, title: "Surface Background", type: "color" }),
      Row({ opt: light.fg, title: "Text", type: "color" }),
      Row({ opt: light.primary.bg, title: "Primary", type: "color" }),
      Row({
        opt: light.primary.accent,
        title: "Primary Accent",
        type: "color",
      }),
      Row({ opt: light.error.bg, title: "Error", type: "color" }),
      Row({ opt: light.error.accent, title: "Error Accent", type: "color" }),
      Row({
        opt: light.success.bg,
        title: "Success Background",
        type: "color",
      }),
      Row({
        opt: light.success.accent,
        title: "Success Accent",
        type: "color",
      }),
      Row({
        opt: light.warning.bg,
        title: "Warning Background",
        type: "color",
      }),
      Row({
        opt: light.warning.accent,
