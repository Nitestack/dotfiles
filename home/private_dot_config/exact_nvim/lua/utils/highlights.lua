...
--------------------------------------------------------------------------------
--  HIGHLIGHTS (credit: https://github.com/akinsho/dotfiles) -> https://github.com/akinsho/dotfiles/blob/main/.config/nvim/lua/as/highlights.lua
--------------------------------------------------------------------------------
local M = {}

---@alias HLAttributes {from: string, attr: "fg" | "bg", alter: integer}
...
---@class HLArgs
---@field blend integer?
---@field fg (string | HLAttributes)?
---@field bg (string | HLAttributes)?
---@field sp (string | HLAttributes)?
---@field bold boolean?
---@field italic boolean?
---@field undercurl boolean?
---@field underline boolean?
...
function M.set(ns, name, opts)
  ...
  core.pcall(string.format("setting highlight \"%s\"", name), vim.api.nvim_set_hl, ns, name, hl)
end
  ...
  core.auto_cmds({
    {
      "ColorScheme",
      {
        group = string.format("%sHighlightOverrides", name:gsub("^%l", string.upper)),
        callback = function()
